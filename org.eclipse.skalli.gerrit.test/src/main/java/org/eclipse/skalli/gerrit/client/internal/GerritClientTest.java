...
public class GerritClientTest {
    ...
    public static void setUpOnce() throws Exception {
        ...
        client = new GerritClientImpl(TEST_HOST, TEST_PORT, TEST_ADMIN_ACCOUNT, privateKey,
    ...
    public static void tearDownOnce() throws Exception {
        ...
        String privateKey = FileUtils.readFileToString(new File(TEST_PRIVATEKEY_FILE));
        EvilGerritClient evilClient = new EvilGerritClient(TEST_HOST, TEST_PORT, TEST_ADMIN_ACCOUNT,
                privateKey, TEST_PASSPHRASE, TEST_ONBEHALFOF);
        evilClient.connect();
    ...
    public void testInvalidProjectNames() throws Exception {
        ...
        for (String invalidProjectName : invalidProjectNames) {
            try {
                client.checkProjectName(invalidProjectName);
    ...
    public void testInvalidGroupNames() throws Exception {
        String[] invalidGroupNames = new String[] { null, "", "  ", "a  b", "a\tb", "<b>html</b>" };
        for (String invalidGroupName : invalidGroupNames) {
            try {
                client.checkGroupName(invalidGroupName);
    ...
    public void testInvalidSettingsIllegalHost() throws Exception {
        new GerritClientImpl(null, TEST_PORT, TEST_ADMIN_ACCOUNT, TEST_PRIVATEKEY_FILE, TEST_PASSPHRASE,
                TEST_ONBEHALFOF);
    }
    ...
    public void testInvalidSettingsUser() throws Exception {
        String privateKey = FileUtils.readFileToString(new File(TEST_PRIVATEKEY_FILE));
        GerritClient invalidClient = new GerritClientImpl(TEST_HOST, TEST_PORT, "LoremIpsum", privateKey,
                TEST_PASSPHRASE,
                TEST_ONBEHALFOF);
        invalidClient.connect();
    }
