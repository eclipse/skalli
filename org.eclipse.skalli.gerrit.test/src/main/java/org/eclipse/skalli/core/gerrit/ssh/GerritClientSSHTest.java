...
import org.eclipse.skalli.core.gerrit.ssh.GerritClientSSH.ResultFormat;
import org.eclipse.skalli.core.gerrit.ssh.GerritClientSSH.Tables;
...
public class GerritClientSSHTest {

    private static final Logger LOG = LoggerFactory.getLogger(GerritClientSSHTest.class);
    ...
    private GerritClientSSH client;
    ...
    public static void tearDownOnce() throws Exception {
        ...
        deleteGroupsQueries.append("DELETE FROM ").append(Tables.ACCOUNT_GROUPS);
        ...
        deleteGroupsQueries.append(" AND group_id NOT IN (SELECT admin_group_id FROM ")
                .append(Tables.SYSTEM_CONFIG).append(")");
        ...
        deleteGroupsQueries.append(" AND group_id NOT IN (SELECT batch_users_group_id FROM ")
                .append(Tables.SYSTEM_CONFIG).append(");");
        // clean up
        deleteGroupsQueries.append("DELETE FROM ").append(Tables.ACCOUNT_GROUP_NAMES)
                .append(" WHERE group_id NOT IN (SELECT group_id FROM ").append(Tables.ACCOUNT_GROUPS)
                .append(");");
        deleteGroupsQueries.append("DELETE FROM ").append(Tables.ACCOUNT_GROUP_MEMBERS)
                .append(" WHERE group_id NOT IN (SELECT group_id FROM ").append(Tables.ACCOUNT_GROUPS)
                .append(");");
        deleteGroupsQueries.append("DELETE FROM ").append(Tables.ACCOUNT_GROUP_MEMBERS_AUDIT)
                .append(" WHERE group_id NOT IN (SELECT group_id FROM ").append(Tables.ACCOUNT_GROUPS)
                .append(");");
        evilClient.gsql(deleteGroupsQueries.toString(), ResultFormat.PRETTY);
        ...
        deleteProjectsQueries.append("DELETE FROM ")
                .append(Tables.PROJECTS).append(" WHERE description = '")
                .append(DESCRIPTION).append("';");
        // clean up
        deleteProjectsQueries.append("DELETE FROM ").append(Tables.REF_RIGHTS)
                .append(" WHERE project_name NOT IN (SELECT name FROM ").append(Tables.PROJECTS).append(");");
        evilClient.gsql(deleteProjectsQueries.toString(), ResultFormat.PRETTY);

        evilClient.disconnect();
    }

    private static class TestGerritClient extends GerritClientSSH implements GerritClient {
    ...
    public void testInvalidSettingsHost() throws Exception {
        ...
        GerritClient invalidClient = new GerritClientSSH(gerritConfig, TEST_ONBEHALFOF);
    ...
    public void testUnsupportedGSQLCommands() throws Exception {
        ...
        for (String invalidCommand : invalidCommands) {
            try {
                client.gsql("SELECT * FROM unknown_table_xyz;" + invalidCommand + " bla bla", ResultFormat.JSON);
     ...
     */
    private static class EvilGerritClient extends GerritClientSSH {
