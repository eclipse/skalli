...
public class FavoritesComponent extends EntityServiceBase<Favorites> implements FavoritesService {

    private static final Logger LOG = LoggerFactory.getLogger(FavoritesComponent.class);
